...
class Investment(models.Model):
    ...
    recent_date = models.DateField(default=timezone.localdate, blank=True, null=True)
...
class Stock(models.Model):
    ...
    purchase_date = models.DateField(default=timezone.localdate, blank=True, null=True)
    ...
    def current_stock_price(self):
        ...
        api_key = '&apikey=J1H4QRDAN1BRNCJ6'
...
class Mutualfund(models.Model):
    ...
    purchased_date = models.DateField(default=timezone.localdate)
    recent_value = models.DecimalField(max_digits=10, decimal_places=2)
    recent_date = models.DateField(default=timezone.localdate, blank=True, null=True)
